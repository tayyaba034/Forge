    ...
    public static string Dispatch(ForgeCommand cmd)
    {
        try
        {
            object result = cmd.tool switch
            {
                ...
                "create_gameobject"      => ForgeGameObjectOps.CreateGameObject(cmd.args),
                "delete_gameobject"      => ForgeObjectOps.DeleteGameObject(cmd.args),
                "duplicate_gameobject"   => ForgeObjectOps.DuplicateGameObject(cmd.args),
                "rename_gameobject"      => ForgeObjectOps.RenameGameObject(cmd.args),
                "create_prefab"          => ForgeObjectOps.CreatePrefab(cmd.args),
                "save_as_prefab"         => ForgeObjectOps.CreatePrefab(cmd.args),
                "instantiate_prefab"     => ForgeObjectOps.InstantiatePrefab(cmd.args),
